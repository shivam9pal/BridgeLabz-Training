...
class Library{
	...
	void searchByTitle(String serTxt)throws BookNotAvailableException  {
		for(Book book:books) {
			if(book.title.toLowerCase().contains(serTxt.toLowerCase())) {
				...
				throw new BookNotAvailableException ("The Book Your are serching is not availabel !!");
			}
		}
...
public class LibraryManagementSystemException {
